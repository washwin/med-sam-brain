...
class Brats(Dataset):
    def __init__(self, args, data_path , transform = None,  mode = 'Training',prompt = 'click', plane = False):
        ...
        self.folder = 'brats_ssa' if args.dataset == 'brats_ssa' else ('brats_2020' if args.dataset == 'brats_2020' else ('brats_men' if args.dataset == 'brats_men' else ('brats_ped' if args.dataset == 'brats_ped' else ('brats' if args.dataset == 'brats' else 'None'))))
